...
|Firefox and VPN Clients|Reports in Firefox and VPN clients are out of scope of our program and they should be submitted using the form: bugzilla.mozilla.org/form.client.bounty|
...
|Injection attacks which require privileged access|Injection attacks such stored XSS and HTML injection which require admin or privileged access to the application are out of scope since the likelihood of exploiting them is considered low|
