...
Our program policy lists an extensive list of out of scope vulnerabilities under scope exclusions section, including [invalid reports which are frequently reported](https://bugzilla.mozilla.org/show_bug.cgi?id=1830029). Make sure the issue you are reporting is not one of them.
